        ...
        {search && (
          <div className="absolute max-lg:hidden flex z-20 top-[70px] left-[300px] h-[60px] xl:w-[700px] lg:w-[400px] rounded-full bg-gray-100 shadow-2xl border-2 border-[#FF7A00]">
            ...
            <input
              placeholder="Search"
              type="text"
              className="w-full outline-none rounded-r-full text-2xl pl-2"
            />
          </div>
        )}
        <nav className="flex-grow ml-10 max-sm:hidden">
          <ul className="flex flex-grow justify-evenly text-lg font-semibold">
            <li className="hover:text-[#FF7A00] cursor-pointer duration-300">
              <NavHashLink smooth activeClassName="active" exact to="/#Main">
                HOME
              </NavHashLink>
            </li>
            <li className="hover:text-[#FF7A00] cursor-pointer duration-300">
              <NavHashLink smooth activeClassName="active" to="/#About">
                ABOUT
              </NavHashLink>
            </li>
            <li className="hover:text-[#FF7A00] cursor-pointer duration-300">
            ...
            <li className="hover:text-[#FF7A00] cursor-pointer duration-300">
              <NavHashLink smooth activeClassName="active" to="/#Services">
                SERVICES
              </NavHashLink>
            </li>
            <li className="hover:text-[#FF7A00] cursor-pointer duration-300">
              <NavHashLink smooth activeClassName="active" to="/#Contact">
                CONTACT
              </NavHashLink>
            </li>
          </ul>
